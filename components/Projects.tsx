...
function Projects({projects}: Props) {
  ...
  return (
    ...
    className='h-screen relative flex overflow-hidden flex-fol text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0'>
        ...
        <div className='relative w-full mt-10 flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar scrollbar-track-gray-600/20 scrollbar-thumb-purple-800/30'>
