...
function About({pageInfo}: Props) {
    ...
    className='flex flex-col relative text-center md:text-left md:flex-row h-screen justify-evenly mx-auto items-center px-10 max-w-7xl'>
        ...
        <motion.img
            className='-mb-20 mt-10 md:mb-0 flex-shrink-0 w-32 h-32 rounded-full object-cover md:rounded-lg md:w-64 md:h-72 xl:h-[400px] xl:w-[500px]'
            initial={{
                x:-200
            }}
            transition={{
        ...
        />
        <div className='space-y-5 -mb-20 px-0 md:px-10'>
